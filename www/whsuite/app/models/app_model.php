 ...
 * App Model
 *
 * The AppModel class is used to provide any global model functionality - all models
 * should extend the AppModel class.
 *
...
class AppModel extends Model
{
    ...
    public function save(array $options = array())
    {
        ...
        if (count($dirty) > 0) {
            ...
            // get the model name for the hook
            $model_class = get_class($this);

            // call the hook
            \App::get('hooks')->callListeners(
                Str::lower($model_class . '-' . $action . '-item'),
                $this
            );
    ...
    public function delete()
    {
        ...
        // call the hook
        \App::get('hooks')->callListeners(
            Str::lower($model_class . '-delete-item'),
            $this
        );
