...
<?php foreach($currencies as $currency): ?>
    <thead>
        <tr>
            ...
            <th><?php echo $lang->get('bandwidth_overage_fee'); ?></th>
            <th><?php echo $lang->get('diskspace_overage_fee'); ?></th>
    ...
    <?php foreach($billing_periods as $period): ?>
        <tr>
            ...
            <td><?php echo $forms->input('Pricing.'.$period->id.'.'.$currency->id.'.bandwidth_overage_fee', null, array('placeholder' => '0.00')); ?></td>
            <td><?php echo $forms->input('Pricing.'.$period->id.'.'.$currency->id.'.diskspace_overage_fee', null, array('placeholder' => '0.00')); ?></td>
