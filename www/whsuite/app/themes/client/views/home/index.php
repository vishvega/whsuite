...
<div class="row">
    ...
    <div class="col-lg-6">
        ...
        <div class="panel panel-info">
            <div class="panel-heading"><?php echo $settings['frontend']['welcometext_header']; ?></div>
            <div class="panel-body">
                <?php echo html_entity_decode($settings['frontend']['welcometext_body']); ?>
            </div>
        </div>

        <div class="panel panel-default">
            <div class="panel-heading"><?php echo $lang->get('new_order'); ?></div>
            <div class="panel-body">
                <a href="<?php echo $router->generate('client-order'); ?>" class="btn btn-success btn-block"><?php echo $lang->get('new_order'); ?></a>
            </div>
        </div>
    </div>
</div>
